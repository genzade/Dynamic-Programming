import howSum from "../../src/tabulation/how-sum";

describe("Tabulation::HowSum", () => {
  it("returns correct result with targetSum = 8", () => {
    ...
    expect(howSum(targetSum, numbers)).toBeOneOf(combinations);
  });
  ...
  it("returns correct result with targetSum = 7, numbers = [2, 4]", () => {
    const targetSum = 7;
    const numbers = [2, 4];
    expect(howSum(targetSum, numbers)).toBe(null);
  });
